...
| **kts-models-crossencoder** | [kts-models-crossencoder-0.1.1.vsix](kts-models-crossencoder-0.1.1.vsix) | 79.7 MB | Cross-encoder model (required for retrieval) |
| **kts-models-spacy** | [kts-models-spacy-0.1.1.vsix](kts-models-spacy-0.1.1.vsix) | 24.41 MB | spaCy language model (required for NLP) |
